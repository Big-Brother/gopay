    ...
    if (name) {
      switch (name) {
        ...
        case 'COPAYER_IN_WALLET':
          body = this.translate.instant('Gopayer already in this wallet');
          break;
        case 'WALLET_FULL':
        ...
        case 'LOCKED_FUNDS':
          ...
          break;
        case 'COPAYER_VOTED':
          body = this.translate.instant('Gopayer already voted on this spend proposal');
          break;
        case 'NOT_AUTHORIZED':
        ...
        case 'TX_NOT_PENDING':
          ...
          break;
        case 'UPGRADE_NEEDED':
          body = this.translate.instant('Please upgrade Gopay to perform this action');
          break;
        case 'BAD_SIGNATURES':
          body = this.translate.instant('Signatures rejected by server');
          break;
        case 'COPAYER_DATA_MISMATCH':
          body = this.translate.instant('Gopayer data mismatch');
          break;
        case 'DUST_AMOUNT':
