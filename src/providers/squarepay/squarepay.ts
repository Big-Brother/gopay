...
@Injectable()
export class SquarePayProvider {
  ...
  constructor(
    ...
    this.logger.info('SquarePayProvider initialized.');
    this.NETWORK = 'livenet';
    this.BITPAY_API_URL = this.NETWORK == 'livenet' ? 'https://squarepay.com' : 'https://test.squarepay.com';
  }
