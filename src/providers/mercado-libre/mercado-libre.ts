...
export class MercadoLibreProvider {
  ...
  public createSquarePayInvoice(data, cb) {
    let dataSrc = {
    ...
    this.http.post(url, dataSrc, headers).subscribe((data: any) => {
      this.logger.info('SquarePay Create Invoice: SUCCESS');
      return cb(null, data);
    }, (data) => {
      this.logger.error('SquarePay Create Invoice: ERROR', JSON.stringify(data));
      return cb(data);
    });
  }

  public getSquarePayInvoice(id, cb) {
    ...
    this.http.get(url, headers).subscribe((data: any) => {
      ...
      this.logger.error('SquarePay Get Invoice: ERROR', JSON.stringify(data));
      return cb(data);
    });
  }
