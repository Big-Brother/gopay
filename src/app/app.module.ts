...
/* Gopay App */
import { GopayApp } from './app.component';

/* Pages */
import { AddPage } from '../pages/add/add';
import { GopayersPage } from '../pages/add/gopayers/gopayers';
...
// Integrations: SquarePayCard
import { SquarePayCardPage } from '../pages/integrations/squarepay-card/squarepay-card';
import { SquarePayCardIntroPage } from '../pages/integrations/squarepay-card/squarepay-card-intro/squarepay-card-intro';
import { SquarePayCardTopUpPage } from '../pages/integrations/squarepay-card/squarepay-card-topup/squarepay-card-topup';
import { SquarePaySettingsPage } from '../pages/integrations/squarepay-card/squarepay-settings/squarepay-settings';
...
@NgModule({
  declarations: [
    ...
    SquarePayCardPage,
    SquarePaySettingsPage,
    SquarePayCardTopUpPage,
    BuyAmazonPage,
    BuyCoinbasePage,
    BuyGlideraPage,
    BuyMercadoLibrePage,
