...
export class FeedbackPage {
  ...
  public goAppStore(): void {
    ...
    let url;
    if (this.isAndroid)
      url = this.appName == 'Gopay' ? defaults.rateApp.gopay.android : defaults.rateApp.squarepay.android;
    if (this.isIOS)
      url = this.appName == 'Gopay' ? defaults.rateApp.gopay.ios : defaults.rateApp.squarepay.ios;
