...
export class ReceivePage {
  ...
  public goGopayers(): void {
    this.navCtrl.push(GopayersPage, { walletId: this.wallet.credentials.walletId });
  };
  ...
  public openWikiBackupNeeded(): void {
    let url = 'https://support.squarepay.com/hc/en-us/articles/115002989283-Why-don-t-I-have-an-online-account-for-my-SquarePay-wallet-';
    let optIn = true;
    let title = null;
