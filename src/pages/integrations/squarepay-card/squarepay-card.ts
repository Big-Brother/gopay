...
@Component({
  selector: 'page-squarepay-card',
  templateUrl: 'squarepay-card.html',
})
export class SquarePayCardPage {
  ...
  public squarepayCardTransactionHistoryCompleted: any;
  public squarepayCardTransactionHistoryConfirming: any;
  public squarepayCardTransactionHistoryPreAuth: any;
  ...
  public update() {
    ...
    this.bitPayCardProvider.getHistory(this.cardId, dateRange, (err, history) => {
      ...
      if (err) {
        ...
        this.squarepayCardTransactionHistoryCompleted = null;
        this.squarepayCardTransactionHistoryConfirming = null;
        this.squarepayCardTransactionHistoryPreAuth = null;
        this.balance = null;
      ...
      this.setGetStarted(history, () => {
        ...
        this.squarepayCardTransactionHistoryConfirming = this.bitPayCardProvider.filterTransactions('confirming', txs);
        this.squarepayCardTransactionHistoryCompleted = this.bitPayCardProvider.filterTransactions('completed', txs);
        this.squarepayCardTransactionHistoryPreAuth = this.bitPayCardProvider.filterTransactions('preAuth', txs);
        ...
        if (this.dateRange.value == 'last30Days') {
          ...
          // TODO?
          // $log.debug('SquarePay Card: storing cache history');
          // let cacheHistory = {
  ...
  public viewOnBlockchain(transactionId: string) {
    let url = 'https://insight.squarepay.com/tx/' + transactionId;
    let optIn = true;
    let title = null;
  ...
  public topUp(): void {
    this.navCtrl.push(AmountPage, {
      id: this.cardId,
      nextPage: 'SquarePayCardTopUpPage',
