...
export class ConfirmPage {
  ...
  ionViewWillEnter() {
    ...
    try {
      ...
      var message = this.translate.instant('Gopay only supports Bitcoin Cash using new version numbers addresses');
      ...
      this.popupProvider.ionicConfirm(null, message, backText, learnText).then((back) => {
        if (!back) {
          var url = 'https://support.squarepay.com/hc/en-us/articles/115004671663';
