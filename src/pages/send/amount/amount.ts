...
import { SquarePayCardTopUpPage } from '../../integrations/squarepay-card/squarepay-card-topup/squarepay-card-topup';
...
export class AmountPage {
  ...
  constructor(
    ...
    // SquarePay Card ID or Wallet ID
