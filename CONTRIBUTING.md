...
If you are having particular problem with your Gopay instalation, please first [search older 
issues](https://github.com/squarepay/gopay/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/squarepay/gopay/wiki/COPAY---FAQ).
...
provide the following information:
 ...
 - Which version of Gopay are you using? (Check Gopay version on the side menu)
 ...
 - Please check Gopay logs (General Settings -> About Gopay -> Session Logs). Look for 
...
We will provide a better channel (like an SquarePay email address) so you can send the information. If possible, please
encrypt your emails using GnuPG.

To open an issue go to [Github Issues](https://github.com/squarepay/gopay/issues).
...
Please adhere to the coding conventions used throughout Gopay (indentation, tests, etc.)
